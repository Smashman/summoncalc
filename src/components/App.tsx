...
export const App: React.FC = () => {
    ...
    return (
        <div className={style.app}>
            ...
            <footer>
                <a id={style.githubLink} href="https://github.com/Smashman/summoncalc" target="_blank" rel="noreferrer" aria-labelledby="github-title">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="256px" height="250px" viewBox="0 0 256 250" version="1.1" preserveAspectRatio="xMidYMid">
